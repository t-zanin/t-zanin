...
| **OilyGiant Oil Well Analysis** | [GitHub Repo](https://github.com/t-zanin/DS-OilyGiant) | Python (Pandas, NumPy, Scikit-learn) | This project was developed for the OilyGiant mining company to identify the best region for developing new oil wells, maximizing profit while minimizing risks. A linear regression model was built to predict the volume of reserves in three regions, using geological exploration data. Bootstrapping was applied to assess profit and risks, with a budget of $100 million for 200 wells and a maximum loss risk of 2.5%.|
| **Beta Bank Churn Prediction** | [GitHub Repo](https://github.com/t-zanin/DS-BetaBankChurn.git) | Python (Pandas, NumPy, Scikit-learn, Seaborn, Matplotlib) | This project was developed for Beta Bank to predict customer churn, aiming to retain existing clients. A Random Forest model with undersampling was used to achieve an F1-score of 0.6165, surpassing the target of 0.59. The model analyzed customer data to identify churn patterns, enabling targeted retention strategies.|
---
